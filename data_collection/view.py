...
from src.ui.dc_widgets import SideBar, HintOverlay
from src.ui.dc_canva import Canva
from src.ui.camera_preview import CameraPreviewLabel
from src.ui.pointer_overlay import PointerOverlay
from src.config import color_primary, color_foreground_light, color_background
...
class DataCollectionView(QWidget):
    ...
    def __init__(self, pointer_enabled=False):
        ...
        self.cam_preview = CameraPreviewLabel(left_vbox_width)
    ...
    def init_sidebar(self, tasks):
        ...
        for t, count in tasks:
            self.sidebar.add_label(t, f"{t:<30}\t0/{count}")

    def increase_task_trial_count(self, t, trail, count):
        self.sidebar.update_label(t, f"{t:<30}\t{trail}/{count}")
