...
class DataCollectionRecorder:
    def __init__(self, output_dir, pid):
        ...
        self.failed_tasks = os.path.join(output_dir, "failed_tasks.csv")
        ...
        with open(self.failed_tasks, "w") as f:
            writer = csv.writer(f)
            writer.writerow(["start_timestamp", "end_timestamp", "task", "trail"])

    def write_task_result(self, timestamp, task_id, trail_id, landmarks):
    ...
    def mark_task_failed(
        ...
        with open(self.failed_tasks, "a", newline="") as f:
            writer = csv.writer(f)
            writer.writerow(
                [
                    start_timestamp,
